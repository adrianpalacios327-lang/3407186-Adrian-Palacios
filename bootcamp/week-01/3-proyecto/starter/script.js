...
console.log("=========================================");
console.log("[aplicacion para el aprendizaje de idiomas] - Numero de ficha");
console.log("=========================================");
console.log("");
...
console.log("Valor principal:    [idiomas 5]");
...
console.log("Valor calculado:    ", 5); // TODO: reemplaza 0 con tu cálculo
...
console.log("Total registros:  [30]");
...
console.log("[Gracias por usar nuestra app de aprendizaje de idiomas]");
