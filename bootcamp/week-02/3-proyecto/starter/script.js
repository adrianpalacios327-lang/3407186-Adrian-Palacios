...
const DOMAIN_NAME = "aplicacion para el aprendizaje de idiomas";
...
console.log(`Nombre: NEWLENGUAASH   ${itemName}`);
console.log(`Categoría: IDIOMAS ${itemCategory}`);
